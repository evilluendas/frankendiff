  ...
  return (
    <>
      ...
      <button
        ...
        className={[
          'fixed bottom-4 sm:bottom-6 will-change-transform right-1/2 translate-x-1/2 sm:right-6 sm:translate-x-0 z-40 flex gap-2 px-5 sm:px-0 items-center justify-center h-14 sm:w-13 sm:h-13 rounded-full bg-fg text-bg shadow-lg cursor-pointer hover:opacity-90 active:scale-95 transition-all duration-250 ease-in-out',
